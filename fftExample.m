...
im = imread ( '/home/lena/Documents/CS_Projects/imageSearch_project/trunk/Dataset/insidecity_a248032.jpg' );
im = double(im) / 255;
...
%- investigate patch match algorithm
%- look at rotation invariance: how do we actually do rotations on images '
%-  