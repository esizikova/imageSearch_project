...
names = { 'stackedLab', 'combinedLab', 'statisticsLab',...
          ...
          'compressedDiagonal','UVBasisFFT','RectangularWindowFFTAngle',...
          'RectangularWindowFFTMagnitude', 'FFTBandDescriptor',...
          'FFTLocalization' };
...
functionHandles = ...
   { @LabStackedHistograms, @LabCombinedHistogram, @LabImageStatistics,...
     ...
     @SVDDiagonal, @SVDBasisFFT, @computeBoundedFFTAngle,...
     @computeBoundedFFTMagnitude, @FFTBandDescriptor, @FFTLocalization };
