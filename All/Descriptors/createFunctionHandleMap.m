...
names = { 'stackedLab', 'combinedLab', 'statisticsLab',...
          ...
          'compressedDiagonal','UVBasisFFT','RectangularWindowFFTAngle','RectangularWindowFFTMagnitude'};
functionHandles = ...
   { @LabStackedHistograms, @LabCombinedHistogram, @LabImageStatistics,...
     ...
     @SVDDiagonal, @SVDBasisFFT, @computeBoundedFFTAngle, @computeBoundedFFTMagnitude};
